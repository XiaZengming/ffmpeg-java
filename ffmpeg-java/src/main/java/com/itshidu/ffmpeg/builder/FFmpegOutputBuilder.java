...
public class FFmpegOutputBuilder extends AbstractFFmpegStreamBuilder<FFmpegOutputBuilder> {
   ...
   * @return this
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_DEPTH_U8
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_DEPTH_S16
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_DEPTH_S32
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_DEPTH_FLT
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_DEPTH_DBL
   ...
   *     constants.
   * @return this
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_FORMAT_U8
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_FORMAT_S16
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_FORMAT_S32
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_FORMAT_FLT
   * @see com.itshidu.ffmpeg.FFmpeg#AUDIO_FORMAT_DBL
   */
